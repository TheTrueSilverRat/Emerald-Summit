/datum/job/roguetown/guildmaster
	...
	tutorial = "You are the leader of the Emerald Summit Guild of Crafts. You represents the interests of all of the craftsmen underneath you - including the Tailor\
